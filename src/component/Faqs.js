...
const Faqs = () => {
  return (
    <div className="row">
      <div className="col-4">
        <h3>Precision Nutrition FAQs</h3>

        <p className="d-flex m-5">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et</p>
      </div>
      <div className="col-8">
        <div className="accordion" id="accordionExample">
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
              ...
              >
              Can I speak to someone about which therapy is best?
              </button>
            </h2>
            <div
              id="collapseThree"
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
              <button
                ...
                aria-controls="collapseThree"
              >
              Can I have an IV therapy based on my genetics? 
              </button>
            </h2>
            <div
              id="collapseThree"
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
              <button
                ...
                aria-controls="collapseThree"
              >
          Can I personalize my IV therapy?
              </button>
            </h2>
            <div
              id="collapseThree"
